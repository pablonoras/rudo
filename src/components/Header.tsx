          ...
          <div className="flex items-center justify-between h-16 sm:h-20">
            ...
            <div className="hidden md:flex items-center justify-center flex-1">
              <nav className="flex items-center gap-8">
                ...
                {/* CTA Button - in center with other nav items */}
                <button 
                  onClick={() => setIsModalOpen(true)}
                  className="bg-gradient-to-r from-[#8A2BE2] to-[#4169E1] text-white px-6 py-2.5 rounded-lg text-sm font-semibold hover:from-[#9932CC] hover:to-[#4682B4] transition-all duration-200 shadow-lg hover:shadow-xl"
                >
                  {t('join-beta')}
                </button>
              </nav>
          ...
          {isMobileMenuOpen && (
            ...
            >
              <nav className="px-4 py-6 space-y-4">
                ...
                {/* Mobile CTA Button - moved before Sign In */}
                <button 
                  onClick={() => {
                    setIsModalOpen(true);
                    setIsMobileMenuOpen(false);
                  }}
                  className="w-full py-4 px-6 bg-gradient-to-r from-[#8A2BE2] to-[#4169E1] text-white rounded-lg text-base font-bold hover:from-[#9932CC] hover:to-[#4682B4] transition-all duration-200 shadow-lg"
                >
                  {t('join-beta')}
                </button>
