export const translations = {
  en: {
    ...
    // PWA Install Banner
    'pwa-add-to-home': 'Get faster access to your workouts',
    'pwa-install-app': 'Get the RUDO app',
    'pwa-install-desktop': 'Install RUDO',
    'pwa-install-generic': 'Get RUDO',
    'pwa-ios-description': 'Tap Share → "Add to Home Screen"',
    'pwa-android-description': 'Install from browser for direct access',
    'pwa-desktop-description': 'Install for better performance',
    'pwa-generic-description': 'Better experience with direct access',
  ...
  es: {
    ...
    // PWA Install Banner
    'pwa-add-to-home': 'Accede más rápido a tus entrenamientos',
    'pwa-install-app': 'Obtén la app RUDO',
    'pwa-install-desktop': 'Instala RUDO',
    'pwa-install-generic': 'Obtén RUDO',
    'pwa-ios-description': 'Toca Compartir → "Agregar a pantalla de inicio"',
    'pwa-android-description': 'Instala desde el navegador para acceso directo',
    'pwa-desktop-description': 'Instala para mejor rendimiento',
    'pwa-generic-description': 'Mejor experiencia con acceso directo',
