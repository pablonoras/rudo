export const translations = {
  en: {
    ...
    'pwa-ios-description': 'Install RUDO: Tap the [SHARE_ICON] Share button → "Add to Home Screen"',
    'pwa-android-description': 'Get faster access to your workouts. Install the RUDO app.',
    'pwa-desktop-description': 'Get desktop app with better performance and offline capability.',
    'pwa-generic-description': 'Install RUDO for faster access to your workouts.',
  ...
  es: {
    ...
    'pwa-ios-description': 'Instalar RUDO: Toca el botón [SHARE_ICON] Compartir → "Agregar a pantalla de inicio"',
    'pwa-android-description': 'Accede más rápido a tus entrenamientos. Instala la app RUDO.',
    'pwa-desktop-description': 'Obtén la app de escritorio con mejor rendimiento y capacidad sin conexión.',
    'pwa-generic-description': 'Instala RUDO para acceder más rápido a tus entrenamientos.',
    'pwa-show-me-how': 'Show me how',
    'pwa-install-now': 'Install now',
    'pwa-install-app-btn': 'Install app',
    'pwa-install-btn': 'Install',
