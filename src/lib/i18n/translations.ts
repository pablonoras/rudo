export const translations = {
  ...
  es: {
    ...
    'no-workouts-today': 'No hay entrenamientos programados para hoy',
    'check-other-days': 'Revisa otros días para tu horario de entrenamiento',
    'inactive-account': 'Cuenta Inactiva',
    'inactive-account-desc': 'Tu cuenta de atleta está actualmente inactiva. No verás ningún entrenamiento o programa asignado hasta que tu entrenador reactive tu cuenta.',
    'what-this-means': 'Lo que esto significa:',
    'no-workouts-displayed': 'No se mostrarán entrenamientos',
